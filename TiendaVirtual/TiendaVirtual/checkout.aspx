<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="checkout.aspx.cs" Inherits="TiendaVirtual.checkout" %>
...
<div class="super_container">
	...
	<header class="header">
		<div class="header_inner d-flex flex-row align-items-center justify-content-start">
			<div class="logo"><a href="#">ARCADIA SPORTWEAR</a></div>
			<nav class="main_nav">
				<ul>
					<li><a href="index.aspx">home</a></li>
					<li><a href="categories.aspx">clothes</a></li>
					<li><a href="categories.aspx">accessories</a></li>
					<li><a href="categories.aspx">lingerie</a></li>
	...
	<div class="menu d-flex flex-column align-items-end justify-content-start text-right menu_mm trans_400">
		...
		<nav class="menu_nav">
			<ul class="menu_mm">
				<li class="menu_mm"><a href="index.aspx">home</a></li>
					...
					<div class="home_container">
						<div class="home_content">
							...
							<div class="breadcrumbs">
								<ul>
									<li><a href="index.aspx">Home</a></li>
									<li><a href="index.aspx">Shopping Cart</a></li>
									<li>Shopping Cart</li>
								</ul>
							</div>
						</div>
